...
import { NetworkFeesDTO } from '../model/networkFeesDTO';
...
export class NetworkRoutesApi {
     ...
     */
    public async getNetworkFees (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NetworkFeesDTO;  }> {
        const localVarPath = this.basePath + '/network/fees';
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: NetworkFeesDTO;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "NetworkFeesDTO");
