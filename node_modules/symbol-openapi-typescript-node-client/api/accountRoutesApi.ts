...
export class AccountRoutesApi {
     ...
     * @param type Transaction types to filter by, separated by commas.
     */
    public async getAccountConfirmedTransactions (accountId: string, pageSize?: number, id?: string, ordering?: string, type?: Array<TransactionTypeEnum>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<TransactionInfoDTO>;  }> {
        ...
        if (type !== undefined) {
            localVarQueryParameters['type'] = ObjectSerializer.serialize(type, "Array<TransactionTypeEnum>");
        }
     ...
     * @param type Transaction types to filter by, separated by commas.
     */
    public async getAccountIncomingTransactions (accountId: string, pageSize?: number, id?: string, ordering?: string, type?: Array<TransactionTypeEnum>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<TransactionInfoDTO>;  }> {
     ...
     * @param type Transaction types to filter by, separated by commas.
     */
    public async getAccountOutgoingTransactions (accountId: string, pageSize?: number, id?: string, ordering?: string, type?: Array<TransactionTypeEnum>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<TransactionInfoDTO>;  }> {
     ...
     * @param type Transaction types to filter by, separated by commas.
     */
    public async getAccountPartialTransactions (accountId: string, pageSize?: number, id?: string, ordering?: string, type?: Array<TransactionTypeEnum>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<TransactionInfoDTO>;  }> {
     ...
     * @param type Transaction types to filter by, separated by commas.
     */
    public async getAccountUnconfirmedTransactions (accountId: string, pageSize?: number, id?: string, ordering?: string, type?: Array<TransactionTypeEnum>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<TransactionInfoDTO>;  }> {
