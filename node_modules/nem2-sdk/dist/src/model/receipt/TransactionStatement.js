...
class TransactionStatement {
    ...
    generateHash() {
        ...
        hasher.update(catbuffer_1.GeneratorUtils.uintToBuffer(ReceiptVersion_1.ReceiptVersion.TRANSACTION_STATEMENT, 2));
        hasher.update(catbuffer_1.GeneratorUtils.uintToBuffer(ReceiptType_1.ReceiptType.Transaction_Group, 2));
        hasher.update(this.source.serialize());
        let receiptBytes = Uint8Array.from([]);
        this.receipts.forEach((receipt) => {
            const bytes = receipt.serialize();
            receiptBytes = catbuffer_1.GeneratorUtils.concatTypedArrays(receiptBytes, bytes);
        });
