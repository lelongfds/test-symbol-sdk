...
class InflationReceipt extends Receipt_1.Receipt {
     ...
     */
    serialize() {
        return new catbuffer_1.InflationReceiptBuilder(ReceiptVersion_1.ReceiptVersion.INFLATION_RECEIPT, this.type.valueOf(), new catbuffer_1.MosaicBuilder(new catbuffer_1.MosaicIdDto(this.mosaicId.toDTO()), new catbuffer_1.AmountDto(this.amount.toDTO()))).serialize();
    }
}
