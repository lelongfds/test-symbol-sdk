...
class ArtifactExpiryReceipt extends Receipt_1.Receipt {
    ...
    serialize() {
        if (this.artifactId instanceof MosaicId_1.MosaicId) {
            return new catbuffer_1.MosaicExpiryReceiptBuilder(ReceiptVersion_1.ReceiptVersion.ARTIFACT_EXPIRY, this.type.valueOf(), new catbuffer_1.MosaicIdDto(this.artifactId.toDTO())).serialize();
        }
        return new catbuffer_1.NamespaceExpiryReceiptBuilder(ReceiptVersion_1.ReceiptVersion.ARTIFACT_EXPIRY, this.type.valueOf(), new catbuffer_1.NamespaceIdDto(this.artifactId.id.toDTO())).serialize();
    }
}
