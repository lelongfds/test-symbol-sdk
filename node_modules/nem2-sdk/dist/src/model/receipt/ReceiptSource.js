...
class ReceiptSource {
     ...
     */
    serialize() {
        return catbuffer_1.GeneratorUtils.concatTypedArrays(catbuffer_1.GeneratorUtils.uintToBuffer(this.primaryId, 4), catbuffer_1.GeneratorUtils.uintToBuffer(this.secondaryId, 4));
    }
}
