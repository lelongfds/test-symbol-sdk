...
class BalanceChangeReceipt extends Receipt_1.Receipt {
     ...
     */
    serialize() {
        return new catbuffer_1.BalanceChangeReceiptBuilder(ReceiptVersion_1.ReceiptVersion.BALANCE_CHANGE, this.type.valueOf(), new catbuffer_1.MosaicBuilder(new catbuffer_1.MosaicIdDto(this.mosaicId.toDTO()), new catbuffer_1.AmountDto(this.amount.toDTO())), new catbuffer_1.KeyDto(Convert_1.Convert.hexToUint8(this.targetPublicAccount.publicKey))).serialize();
    }
}
