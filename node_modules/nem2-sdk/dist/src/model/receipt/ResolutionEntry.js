...
class ResolutionEntry {
    ...
    serialize() {
        ...
        if (this.resolved instanceof Address_1.Address) {
            ...
            resolvedBytes = catbuffer_1.GeneratorUtils.uint64ToBuffer(UInt64_1.UInt64.fromHex(this.resolved.toHex()).toDTO());
        }
        const sourceBytes = this.source.serialize();
        return catbuffer_1.GeneratorUtils.concatTypedArrays(resolvedBytes, sourceBytes);
    }
}
