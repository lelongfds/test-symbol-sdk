...
class Address {
    ...
    static createFromEncoded(encoded) {
        return Address.createFromRawAddress(format_1.RawAddress
            .addressToString(format_1.Convert.hexToUint8(encoded)));
    }
    /**
 ...
 */
Address.isValidRawAddress = (rawAddress, networkType) => {
    try {
        return format_1.RawAddress.isValidAddress(format_1.RawAddress.stringToAddress(rawAddress), networkType);
    }
    catch (err) {
        return false;
    }
 ...
 */
Address.isValidEncodedAddress = (encoded, networkType) => {
    try {
        return format_1.RawAddress.isValidAddress(format_1.Convert.hexToUint8(encoded), networkType);
    }
    catch (err) {
        return false;
    }
