...
class MosaicDefinitionTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        const builder = isEmbedded ? catbuffer_1.EmbeddedMosaicDefinitionTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload)) :
            catbuffer_1.MosaicDefinitionTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
    ...
    getMosaicNonceIntValue() {
        return catbuffer_1.GeneratorUtils.readUint32At(this.nonce.toDTO(), 0);
    }
    /**
     * @internal
     * @returns {Uint8Array}
    ...
    generateBytes() {
        ...
        const transactionBuilder = new catbuffer_1.MosaicDefinitionTransactionBuilder(new catbuffer_1.SignatureDto(signatureBuffer), new catbuffer_1.KeyDto(signerBuffer), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_DEFINITION.valueOf(), new catbuffer_1.AmountDto(this.maxFee.toDTO()), new catbuffer_1.TimestampDto(this.deadline.toDTO()), new catbuffer_1.MosaicIdDto(this.mosaicId.id.toDTO()), new catbuffer_1.BlockDurationDto(this.duration.toDTO()), new catbuffer_1.MosaicNonceDto(this.getMosaicNonceIntValue()), this.flags.getValue(), this.divisibility);
    ...
    toEmbeddedTransaction() {
        return new catbuffer_1.EmbeddedMosaicDefinitionTransactionBuilder(new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.signer.publicKey)), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_DEFINITION.valueOf(), new catbuffer_1.MosaicIdDto(this.mosaicId.id.toDTO()), new catbuffer_1.BlockDurationDto(this.duration.toDTO()), new catbuffer_1.MosaicNonceDto(this.getMosaicNonceIntValue()), this.flags.getValue(), this.divisibility);
    }
    /**
     * @internal
     * @returns {MosaicDefinitionTransaction}
