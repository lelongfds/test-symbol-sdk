...
class AccountLinkTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        const builder = isEmbedded ? catbuffer_1.EmbeddedAccountLinkTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload)) :
            catbuffer_1.AccountLinkTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
    ...
    generateBytes() {
        ...
        const transactionBuilder = new catbuffer_1.AccountLinkTransactionBuilder(new catbuffer_1.SignatureDto(signatureBuffer), new catbuffer_1.KeyDto(signerBuffer), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.ACCOUNT_LINK.valueOf(), new catbuffer_1.AmountDto(this.maxFee.toDTO()), new catbuffer_1.TimestampDto(this.deadline.toDTO()), new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.remotePublicKey)), this.linkAction.valueOf());
    ...
    toEmbeddedTransaction() {
        return new catbuffer_1.EmbeddedAccountLinkTransactionBuilder(new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.signer.publicKey)), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.ACCOUNT_LINK.valueOf(), new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.remotePublicKey)), this.linkAction.valueOf());
    }
    /**
     * @internal
     * @returns {AccountLinkTransaction}
