...
class MosaicGlobalRestrictionTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        const builder = isEmbedded ? catbuffer_1.EmbeddedMosaicGlobalRestrictionTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload)) :
            catbuffer_1.MosaicGlobalRestrictionTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
    ...
    generateBytes() {
        ...
        const transactionBuilder = new catbuffer_1.MosaicGlobalRestrictionTransactionBuilder(new catbuffer_1.SignatureDto(signatureBuffer), new catbuffer_1.KeyDto(signerBuffer), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_GLOBAL_RESTRICTION.valueOf(), new catbuffer_1.AmountDto(this.maxFee.toDTO()), new catbuffer_1.TimestampDto(this.deadline.toDTO()), new catbuffer_1.UnresolvedMosaicIdDto(this.mosaicId.id.toDTO()), new catbuffer_1.UnresolvedMosaicIdDto(this.referenceMosaicId.id.toDTO()), this.restrictionKey.toDTO(), this.previousRestrictionValue.toDTO(), this.newRestrictionValue.toDTO(), this.previousRestrictionType.valueOf(), this.newRestrictionType.valueOf());
    ...
    toEmbeddedTransaction() {
        return new catbuffer_1.EmbeddedMosaicGlobalRestrictionTransactionBuilder(new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.signer.publicKey)), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_GLOBAL_RESTRICTION.valueOf(), new catbuffer_1.UnresolvedMosaicIdDto(this.mosaicId.id.toDTO()), new catbuffer_1.UnresolvedMosaicIdDto(this.referenceMosaicId.id.toDTO()), this.restrictionKey.toDTO(), this.previousRestrictionValue.toDTO(), this.newRestrictionValue.toDTO(), this.previousRestrictionType.valueOf(), this.newRestrictionType.valueOf());
    }
    /**
     * @internal
