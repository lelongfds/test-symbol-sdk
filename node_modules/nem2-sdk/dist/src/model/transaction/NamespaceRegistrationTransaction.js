...
const catbuffer_1 = require("catbuffer");
...
class NamespaceRegistrationTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        const builder = isEmbedded ? catbuffer_1.EmbeddedNamespaceRegistrationTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload)) :
            catbuffer_1.NamespaceRegistrationTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
    ...
    generateBytes() {
        ...
        if (this.registrationType === NamespaceRegistrationType_1.NamespaceRegistrationType.RootNamespace) {
            transactionBuilder = new catbuffer_1.NamespaceRegistrationTransactionBuilder(new catbuffer_1.SignatureDto(signatureBuffer), new catbuffer_1.KeyDto(signerBuffer), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_REGISTRATION.valueOf(), new catbuffer_1.AmountDto(this.maxFee.toDTO()), new catbuffer_1.TimestampDto(this.deadline.toDTO()), new catbuffer_1.NamespaceIdDto(this.namespaceId.id.toDTO()), format_1.Convert.hexToUint8(format_1.Convert.utf8ToHex(this.namespaceName)), new catbuffer_1.BlockDurationDto(this.duration.toDTO()), undefined);
        }
        else {
            transactionBuilder = new catbuffer_1.NamespaceRegistrationTransactionBuilder(new catbuffer_1.SignatureDto(signatureBuffer), new catbuffer_1.KeyDto(signerBuffer), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_REGISTRATION.valueOf(), new catbuffer_1.AmountDto(this.maxFee.toDTO()), new catbuffer_1.TimestampDto(this.deadline.toDTO()), new catbuffer_1.NamespaceIdDto(this.namespaceId.id.toDTO()), format_1.Convert.hexToUint8(format_1.Convert.utf8ToHex(this.namespaceName)), undefined, new catbuffer_1.NamespaceIdDto(this.parentId.id.toDTO()));
        }
    ...
    toEmbeddedTransaction() {
        if (this.registrationType === NamespaceRegistrationType_1.NamespaceRegistrationType.RootNamespace) {
            return new catbuffer_1.EmbeddedNamespaceRegistrationTransactionBuilder(new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.signer.publicKey)), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_REGISTRATION.valueOf(), new catbuffer_1.NamespaceIdDto(this.namespaceId.id.toDTO()), format_1.Convert.hexToUint8(format_1.Convert.utf8ToHex(this.namespaceName)), new catbuffer_1.BlockDurationDto(this.duration.toDTO()), undefined);
        }
        return new catbuffer_1.EmbeddedNamespaceRegistrationTransactionBuilder(new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.signer.publicKey)), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_REGISTRATION.valueOf(), new catbuffer_1.NamespaceIdDto(this.namespaceId.id.toDTO()), format_1.Convert.hexToUint8(format_1.Convert.utf8ToHex(this.namespaceName)), undefined, new catbuffer_1.NamespaceIdDto(this.parentId.id.toDTO()));
    }
    /**
     * @internal
     * @returns {NamespaceRegistrationTransaction}
