...
class AddressAliasTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        const builder = isEmbedded ? catbuffer_1.EmbeddedAddressAliasTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload)) :
            catbuffer_1.AddressAliasTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
    ...
    generateBytes() {
        ...
        const transactionBuilder = new catbuffer_1.AddressAliasTransactionBuilder(new catbuffer_1.SignatureDto(signatureBuffer), new catbuffer_1.KeyDto(signerBuffer), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.ADDRESS_ALIAS.valueOf(), new catbuffer_1.AmountDto(this.maxFee.toDTO()), new catbuffer_1.TimestampDto(this.deadline.toDTO()), new catbuffer_1.NamespaceIdDto(this.namespaceId.id.toDTO()), new catbuffer_1.AddressDto(format_1.RawAddress.stringToAddress(this.address.plain())), this.aliasAction.valueOf());
    ...
    toEmbeddedTransaction() {
        return new catbuffer_1.EmbeddedAddressAliasTransactionBuilder(new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.signer.publicKey)), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.ADDRESS_ALIAS.valueOf(), new catbuffer_1.NamespaceIdDto(this.namespaceId.id.toDTO()), new catbuffer_1.AddressDto(format_1.RawAddress.stringToAddress(this.address.plain())), this.aliasAction.valueOf());
    }
    /**
     * @internal
     * @returns {AddressAliasTransaction}
