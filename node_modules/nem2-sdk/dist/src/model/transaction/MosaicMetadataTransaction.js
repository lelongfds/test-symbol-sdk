...
class MosaicMetadataTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        const builder = isEmbedded ? catbuffer_1.EmbeddedMosaicMetadataTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload)) :
            catbuffer_1.MosaicMetadataTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
    ...
    generateBytes() {
        ...
        const transactionBuilder = new catbuffer_1.MosaicMetadataTransactionBuilder(new catbuffer_1.SignatureDto(signatureBuffer), new catbuffer_1.KeyDto(signerBuffer), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_METADATA.valueOf(), new catbuffer_1.AmountDto(this.maxFee.toDTO()), new catbuffer_1.TimestampDto(this.deadline.toDTO()), new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.targetPublicKey)), this.scopedMetadataKey.toDTO(), new catbuffer_1.UnresolvedMosaicIdDto(this.targetMosaicId.id.toDTO()), this.valueSizeDelta, format_1.Convert.utf8ToUint8(this.value));
    ...
    toEmbeddedTransaction() {
        return new catbuffer_1.EmbeddedMosaicMetadataTransactionBuilder(new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.signer.publicKey)), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_METADATA.valueOf(), new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.targetPublicKey)), this.scopedMetadataKey.toDTO(), new catbuffer_1.UnresolvedMosaicIdDto(this.targetMosaicId.id.toDTO()), this.valueSizeDelta, format_1.Convert.utf8ToUint8(this.value));
    }
    /**
     * @internal
