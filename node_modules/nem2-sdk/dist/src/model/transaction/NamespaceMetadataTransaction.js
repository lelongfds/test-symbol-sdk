...
class NamespaceMetadataTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        const builder = isEmbedded ? catbuffer_1.EmbeddedNamespaceMetadataTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload)) :
            catbuffer_1.NamespaceMetadataTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
        const signerPublicKey = format_1.Convert.uint8ToHex(builder.getSignerPublicKey().key);
        const networkType = builder.getNetwork().valueOf();
        const transaction = NamespaceMetadataTransaction.create(isEmbedded ? Deadline_1.Deadline.create() :
    ...
    generateBytes() {
        ...
        const transactionBuilder = new catbuffer_1.NamespaceMetadataTransactionBuilder(new catbuffer_1.SignatureDto(signatureBuffer), new catbuffer_1.KeyDto(signerBuffer), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_METADATA.valueOf(), new catbuffer_1.AmountDto(this.maxFee.toDTO()), new catbuffer_1.TimestampDto(this.deadline.toDTO()), new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.targetPublicKey)), this.scopedMetadataKey.toDTO(), new catbuffer_1.NamespaceIdDto(this.targetNamespaceId.id.toDTO()), this.valueSizeDelta, format_1.Convert.utf8ToUint8(this.value));
    ...
    toEmbeddedTransaction() {
        return new catbuffer_1.EmbeddedNamespaceMetadataTransactionBuilder(new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.signer.publicKey)), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_METADATA.valueOf(), new catbuffer_1.KeyDto(format_1.Convert.hexToUint8(this.targetPublicKey)), this.scopedMetadataKey.toDTO(), new catbuffer_1.NamespaceIdDto(this.targetNamespaceId.id.toDTO()), this.valueSizeDelta, format_1.Convert.utf8ToUint8(this.value));
    }
    /**
     * @internal
     * @returns {NamespaceMetadataTransaction}
