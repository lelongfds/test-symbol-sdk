...
class AggregateTransactionService {
     ...
     */
    constructor(multisigRepository) {
    ...
    isComplete(signedTransaction) {
        ...
        return rxjs_1.from(aggregateTransaction.innerTransactions).pipe(operators_1.mergeMap((innerTransaction) => this.multisigRepository.getMultisigAccountInfo(innerTransaction.signer.address)
            .pipe(
        /**
