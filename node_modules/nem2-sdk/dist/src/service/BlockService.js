...
const positionEnum_1 = require("nem2-sdk-openapi-typescript-node-client/dist/model/positionEnum");
...
class BlockService {
    ...
    validateTransactionInBlock(leaf, height) {
        ...
        return rxjs_1.combineLatest(rootHashObservable, merklePathItemObservable).pipe(operators_1.map((combined) => this.validateInBlock(leaf, combined[1].merklePath, combined[0].blockTransactionsHash))).pipe(operators_1.catchError(() => rxjs_1.of(false)));
    }
    /**
    ...
    validateStatementInBlock(leaf, height) {
        ...
        return rxjs_1.combineLatest(rootHashObservable, merklePathItemObservable).pipe(operators_1.map((combined) => this.validateInBlock(leaf, combined[1].merklePath, combined[0].blockReceiptsHash))).pipe(operators_1.catchError(() => rxjs_1.of(false)));
    }
    /**
     * @internal
