...
// tslint:disable-next-line:one-variable-per-declaration
const gf0 = exports.gf(), gf1 = exports.gf([1]), _121665 = exports.gf([0xdb41, 1]), D = exports.gf([0x78a3, 0x1359, 0x4dca, 0x75eb, 0xd8ab, 0x4141, 0x0a4d,
    0x0070, 0xe898, 0x7779, 0x4079, 0x8cc7, 0xfe73, 0x2b6f, 0x6cee, 0x5203,
]), D2 = exports.gf([0xf159, 0x26b2, 0x9b94, 0xebd6, 0xb156, 0x8283, 0x149a,
    0x00e0, 0xd130, 0xeef3, 0x80f2, 0x198e, 0xfce7, 0x56df, 0xd9dc, 0x2406,
]), X = exports.gf([0xd51a, 0x8f25, 0x2d60, 0xc956, 0xa7b2, 0x9525, 0xc760,
    0x692c, 0xdc5c, 0xfdd6, 0xe231, 0xc0a4, 0x53fe, 0xcd6e, 0x36d3, 0x2169,
]), Y = exports.gf([0x6658, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666,
    0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666,
]), I = exports.gf([0xa0b0, 0x4a0e, 0x1b27, 0xc4ee, 0xe478, 0xad2f, 0x1806,
...
exports.crypto_shared_key_hash = (shared, pk, sk, hashfunc) => {
    const d = new Uint8Array(64);
    const p = [exports.gf(), exports.gf(), exports.gf(), exports.gf()];
    hashfunc(d, sk, 32);
    d[0] &= 248;
    d[31] &= 127;
    d[31] |= 64;
    const q = [exports.gf(), exports.gf(), exports.gf(), exports.gf()];
