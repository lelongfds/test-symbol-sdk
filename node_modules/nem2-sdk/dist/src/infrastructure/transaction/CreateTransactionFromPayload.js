...
exports.CreateTransactionFromPayload = (payload, isEmbedded = false) => {
    const transactionBuilder = isEmbedded ? catbuffer_1.EmbeddedTransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload)) :
        catbuffer_1.TransactionBuilder.loadFromBinary(format_1.Convert.hexToUint8(payload));
