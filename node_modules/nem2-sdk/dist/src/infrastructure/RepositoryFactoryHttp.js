...
class RepositoryFactoryHttp {
    ...
    constructor(url, networkType, generationHash) {
        ...
        this.generationHash = generationHash ? rxjs_1.of(generationHash) :
            this.createBlockRepository().getBlockByHeight(UInt64_1.UInt64.fromUint(1)).pipe(operators_1.map((b) => b.generationHash)).pipe(operators_1.shareReplay(1));
    }
