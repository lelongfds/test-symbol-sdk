...
class SimpleWallet extends Wallet_1.Wallet {
    ...
    static createFromDTO(simpleWalletDTO) {
        return new SimpleWallet(simpleWalletDTO.name, simpleWalletDTO.network, Address_1.Address.createFromRawAddress(simpleWalletDTO.address.address), js_joda_1.LocalDateTime.now(), new EncryptedPrivateKey_1.EncryptedPrivateKey(simpleWalletDTO.encryptedPrivateKey.encryptedKey, simpleWalletDTO.encryptedPrivateKey.iv));
    }
    /**
