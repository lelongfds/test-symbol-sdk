...
class MosaicService {
    ...
    mosaicsView(mosaicIds) {
        return rxjs_1.of(mosaicIds).pipe(operators_1.mergeMap((_) => this.mosaicRepository.getMosaics(mosaicIds).pipe(operators_1.mergeMap((info) => info), operators_1.map((mosaicInfo) => {
